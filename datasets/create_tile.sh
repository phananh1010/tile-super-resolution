...
#example ./create_tile.sh ./segment_vids/paris_8_1.mp4 192 192 1680 938
...
dirname4=${dirname}_fps4
dirname2=${dirname}_fps2
dirname1=${dirname}_fps1
...
#create 192x192 vid
echo "yes | ffmpeg -i \"$inputvid\" -filter:v \"crop=$2:$3:$4:$5\"  ./$dirname/${w0}x${h0}.mp4 || true"
yes | ffmpeg -i "$inputvid" -filter:v "crop=$2:$3:$4:$5"  ./$dirname/${w0}x${h0}.mp4 || true
...
mkdir $dirname4 || true
yes | ffmpeg -i $inputvid -filter:v "crop=$2:$3:$4:$5, fps=4"  ./$dirname4/${w0}x${h0}.mp4 || true
...
mkdir $dirname2 || true
yes | ffmpeg -i $inputvid -filter:v "crop=$2:$3:$4:$5, fps=2"  ./$dirname2/${w0}x${h0}.mp4 || true
...
mkdir $dirname1 || true
yes | ffmpeg -i $inputvid -filter:v "crop=$2:$3:$4:$5, fps=1"  ./$dirname1/${w0}x${h0}.mp4 || true
